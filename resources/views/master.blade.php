    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            ...
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                ...
                <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="{{ asset ('style/assets/img/DSC02007.png') }}" alt="..." /></span>
            </a>
            ...
            <h6 class="mb-0">
            <a >Modul praktikum pemrograman web lanjut tahun @include('tahun')</a>
</h6>
